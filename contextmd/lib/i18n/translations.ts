...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    emergency: {
      ...
      subheading: 'Triaje helps you describe your symptoms and get asynchronous clinical guidance. It is not a substitute for emergency care.',
      ...
      disclaimer: 'Triaje does not provide medical diagnosis or treatment. Responses are for informational purposes only and do not replace professional medical advice. In a life-threatening emergency, always call 911.',
    ...
    intake: {
      ...
      disclaimer: 'Triaje does not provide medical diagnosis or treatment. Responses are for informational purposes only and do not replace professional medical advice.',
  ...
  fr: {
    ...
    emergency: {
      ...
      subheading: "Triaje vous aide à décrire vos symptômes et à obtenir une orientation clinique asynchrone. Ce n'est pas un substitut aux soins d'urgence.",
      ...
      disclaimer: "Triaje ne fournit pas de diagnostic ou de traitement médical. Les réponses sont fournies à titre informatif seulement et ne remplacent pas un avis médical professionnel. En cas d'urgence mettant la vie en danger, composez toujours le 911.",
    ...
    intake: {
      ...
      disclaimer: "Triaje ne fournit pas de diagnostic ou de traitement médical. Les réponses sont fournies à titre informatif seulement et ne remplacent pas un avis médical professionnel.",
